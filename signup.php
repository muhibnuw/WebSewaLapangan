	...
	<body>
			...
			<div id="top-header"  style="background-color: chocolate"> 
				<div class="container">
					...
					<ul class="header-links pull-right">
						<li><a href="signup.php"><i class="fa fa-user-o"></i> My Account</a></li>
					</ul>
				</div>
			</div>
			<!-- /TOP HEADER -->
		...
		<div class="section">
			...
			<div class="container">
					...
					<?php $id = $_GET['id'];?>
						<form method="post" action="proses1.php?id=<?=$id;?>" enctype="multipart/form-data">
						<div class="form-group">
						<input type="hidden" name="id" value="<?= $id?>">
		 				</div>
							<div class="form-group">
								<input class="input" type="text" name="fullname" placeholder="Nama lengkap" required>
							</div>
							
                            <div class="form-group">
                                <input class="input" type="text" name="cardnumber" placeholder="Nomor identitas (KTP/SIM/Passpor/Kartu siswa/KTM)" required>
                            </div>
							<div class="form-group">
							...
							<div class="form-group">
								<input class="input" type="text" name="telepon" placeholder="No. Telepon/HP" required>
							</div>
							<div class="form-group">
								<input class="btn btn-danger" type="submit" name="create" value="create">
							</div>
						</form>
