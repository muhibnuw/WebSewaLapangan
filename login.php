	...
	<body>
		...
		<div id="breadcrumb" class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<h3 class="breadcrumb-header">Login Admin</h3>
					</div>
				</div>
				<!-- /row -->
			</div>
		...
		<div class="section">
			...
			<div class="container">
					...
					<div class="form-group">
								<input class="input" type="text" name="myadmin" placeholder="Username" required>
								
							</div>
							<div class="form-group">
								<input class="input password" type="password" name="password" placeholder="Your Password" required>
